...
import { handler } from '../assets/src/UsersFunction/users';
...
import * as createUserEvent from '../events/event-post-user.json';
import * as deleteUserEvent from '../events/event-delete-user-by-id.json';
import * as getUserEvent from '../events/event-get-user-by-id.json';
import * as getUsersEvent from '../events/event-get-all-users.json';
import * as updateUserEvent from '../events/event-put-user-by-id.json';
